...
|---|---|---|---|---|
| Document artifact links | Stabilizing | Proposal/spec/ADR/plan artifacts are linked by policy ledger. | `cargo xtask policy-report` | `check-doc-artifacts` planned as follow-up checker. |
