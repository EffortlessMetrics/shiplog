...
`shiplog` has three verification surfaces:
...
Pull requests run advisory `ripr` evidence, reviewer guidance, fast gates, docs checks, publish preflight, example smoke checks, and targeted mutation when routing rules require it.
