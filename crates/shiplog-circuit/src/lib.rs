...
impl CircuitBreaker {
    ...
    pub fn is_available(&mut self, name: &str) -> bool {
        // Get the timeout value first to avoid borrow issues
    ...
    pub fn record_success(&mut self, name: &str) {
        // Get threshold values first to avoid borrow issues
...
mod tests {
    ...
    fn test_circuit_breaker_initial_state() {
        ...
        // Initial state should be closed (available)
    ...
    fn test_circuit_closes_after_successes() {
        ...
        // Now is_available should transition to half-open
        assert!(breaker.is_available("test"));
